...
export const postCreateOrderHandler = rest.post(
  'https://exampleapi.com.co/create-order',
  (_, res, ctx) => {
...
export const getOrderCheckHandler = rest.get(
  'https://exampleapi.com.co/check-order/:id',
  (_, res, ctx) => {
...
export const getMenuByCategory = rest.get(
  'https://exampleapi.com.co/menu/categories',
  (_, res, ctx) => {
...
export const getDetailOrderHandler = rest.get(
  'https://exampleapi.com.co/detail-order/:id',
  (_, res, ctx) => {
...
export const changeOrderStateHandler = rest.patch(
  'https://exampleapi.com.co/orders/:id',
  (_, res, ctx) => {
